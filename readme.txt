...
Once the pattern explorer is fully integrated into WordPress, this project will be sunsetted in favor of the core offering.
...
3. Once activated, navigate to the Block Editor, and you will see the "Insert Pattern" button in the header toolbar. See the plugin screenshots for reference.
